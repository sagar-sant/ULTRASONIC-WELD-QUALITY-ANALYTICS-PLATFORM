%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File Name   : IWLE_Core.m
% Project     : Ultrasonic Weld Quality Analytics Platform
% Description :
% Main application of the Ultrasonic Weld Quality Analytics Platform.
% This program integrates digital image processing, feature extraction,
% machine learning-based weld quality prediction, confidence estimation,
% defect visualization, and automated inspection report generation through
% the Intelligent Weld Learning Engine (IWLE).
%
% Author      : Sagar Sant
