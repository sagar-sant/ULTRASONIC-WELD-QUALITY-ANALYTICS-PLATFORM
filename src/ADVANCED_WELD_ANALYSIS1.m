%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File Name   : ADVANCED_WELD_ANALYSIS1.m
% Project     : Ultrasonic Weld Quality Analytics Platform
% Description :
% Performs advanced ultrasonic weld image analysis using digital image
% processing techniques. The function executes preprocessing, automatic
% weld ROI detection, contrast enhancement, crack detection, fracture
% analysis, texture analysis, feature extraction, quality scoring,
% confidence estimation, and defect visualization.
%
% Author      : Sagar Sant
